...
class UsoVeiculoController:
    ...
    def registrar_uso(self, veiculo_placa, motorista, data_inicial, data_final, km_inicial, km_final):
        registro_uso = self.registrar_uso_veiculo_use_case.registrar_uso(veiculo_placa, motorista, data_inicial, data_final, km_inicial, km_final)
